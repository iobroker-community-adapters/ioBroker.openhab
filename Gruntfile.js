...
module.exports = function (grunt) {
    ...
    if (process.argv[2] == 'rename') {
        ...
        if (!newname) {
            console.log('Please write the new pimatic name, like: "grunt rename --name=mywidgetset" --author="Author Name"');
            process.exit();
        }
        ...
        if (fs.existsSync(__dirname + '/admin/pimatic.png')) {
            fs.renameSync(__dirname + '/admin/pimatic.png',              __dirname + '/admin/' + newname + '.png');
        }
        if (fs.existsSync(__dirname + '/widgets/pimatic.html')) {
            fs.renameSync(__dirname + '/widgets/pimatic.html',           __dirname + '/widgets/' + newname + '.html');
        }
        if (fs.existsSync(__dirname + '/widgets/pimatic/js/pimatic.js')) {
            fs.renameSync(__dirname + '/widgets/pimatic/js/pimatic.js', __dirname + '/widgets/pimatic/js/' + newname + '.js');
        }
        if (fs.existsSync(__dirname + '/widgets/pimatic')) {
            fs.renameSync(__dirname + '/widgets/pimatic',                __dirname + '/widgets/' + newname);
        }
    }
            ...
            name: {
                options: {
                    patterns: [
                        ...
                        {
                            match: /Pimatic/g,
                            replacement: newname ? (newname[0].toUpperCase() + newname.substring(1)) : 'Pimatic'
                        },
                        {
                            match: /bluefox/g,
                            replacement: author
